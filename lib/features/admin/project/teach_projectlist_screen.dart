...
class _TeacchProjectsScreenState extends State<TeacchProjectsScreen> {
  ...
  Stream<QuerySnapshot> _getProjectsStream() {
    ...
    if (_searchQuery.isNotEmpty) {
      // For case-insensitive search, we need to store projectName in lowercase
      // or use a more complex solution
      query = query
          .where('namefilter', arrayContains: _searchController.text.toLowerCase());
    }
  ...
  Widget _projectCard(
      String title, String department, String status, Map<String, dynamic> projectData) {
    Color statusColor;
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          onTap: () {
            ...
            // Navigator.push(context, MaterialPageRoute(builder: (context) => ProjectDetailsScreen(projectData: projectData)));
          },
          child: Padding(
              ...
              children: [
                Container(
                  ...
                  child: const Icon(Icons.folder,
                      color: Color(0xFF8C7CD4), size: 30),
                ),
